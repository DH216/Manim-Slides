...
class Scene2_8(Slide):
    def construct(self):
        ...
        torch_logo = SVGMobject("./Imgs/Scene8/pytorch_logo.svg", z_index=1, height=2)
        deepinv_logo = (
            ImageMobject("./Imgs/Scene8/deepinv_logo.png", z_index=1)
        ...
        mnist_0 = (
            ImageMobject("./Imgs/Scene8/mnist_0.png", z_index=1)
        ...
        mnist_1 = (
            ImageMobject("./Imgs/Scene8/mnist_1.png", z_index=1)
            .set_resampling_algorithm(RESAMPLING_ALGORITHMS["none"])
            .scale_to_fit_width(1)
        )
        mnist_1.add(SurroundingRectangle(mnist_1, color=WHITE, buff=0.2))
        mnist_2 = (
            ImageMobject("./Imgs/Scene8/mnist_2.png", z_index=1)
            .set_resampling_algorithm(RESAMPLING_ALGORITHMS["none"])
            .scale_to_fit_width(1)
        )
        mnist_2.add(SurroundingRectangle(mnist_2, color=WHITE, buff=0.2))
        mnist_3 = (
            ImageMobject("./Imgs/Scene8/mnist_3.png", z_index=1)
            .set_resampling_algorithm(RESAMPLING_ALGORITHMS["none"])
            .scale_to_fit_width(1)
        )
        ...
        clean_img = (
            ImageMobject("./Imgs/Scene8/mnist_0.png")
            .set_resampling_algorithm(RESAMPLING_ALGORITHMS["none"])
            .scale_to_fit_width(1)
        )
        ...
        noised_img = (
            ImageMobject("./Imgs/Scene8/mnist_0_noised.png")
            .set_resampling_algorithm(RESAMPLING_ALGORITHMS["none"])
            .scale_to_fit_width(1)
