...
class Scene2_7(MovingCameraScene,Slide):
    def construct(self):
        ...
        self.play(FadeOut(final_loss, elbo_l2))
        ...
        arrows = VGroup(
            Arrow(step1_rect.get_right(), step2_rect.get_left(), color=WHITE, buff=0.1),
            Arrow(step2_rect.get_right(), step3_rect.get_left(), color=WHITE, buff=0.1),
            Arrow(step3_rect.get_bottom(), step4_rect.get_top(), color=WHITE, buff=0.1),
            Arrow(step4_rect.get_left(), step5_rect.get_right(), color=WHITE, buff=0.1),
            Arrow(step5_rect.get_left(), step6_rect.get_right(), color=WHITE, buff=0.1),
        )
        ...
        self.play(
            LaggedStart(
                FadeOut(cross_sum), 
                Transform(eq_step6, eq_step6_expectation),
                lag_ratio=0.5
            )
        )
