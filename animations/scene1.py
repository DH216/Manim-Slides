...
class Scene2_1(Slide):
    def construct(self):
        ...
        # Load images
        ddpm_p0 = ImageMobject("Imgs/Scene1/ddpm_0", z_index=2).scale_to_fit_width(3)
        ddpm_p1 = ImageMobject("Imgs/Scene1/ddpm_1", z_index=1).scale_to_fit_width(3)
        ddpm_p2 = ImageMobject("Imgs/Scene1/ddpm_2", z_index=0).scale_to_fit_width(3)

        diffusion_p0 = ImageMobject(
            "Imgs/Scene1/diffusion_0", z_index=2
        ).scale_to_fit_width(3)
        diffusion_p1 = ImageMobject(
            "Imgs/Scene1/diffusion_1", z_index=1
        ).scale_to_fit_width(3)
        diffusion_p2 = ImageMobject(
            "Imgs/Scene1/diffusion_2", z_index=0
        ).scale_to_fit_width(3)
        ...
        img0_noise60 = ImageMobject("Imgs/Scene1/ffhq_0_noise_60").scale_to_fit_width(
            2 * img0.width
        )
        pure_noise = ImageMobject("Imgs/Scene1/pure_noise").scale_to_fit_width(
            2 * img0.width
        )
